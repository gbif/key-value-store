 ...
 */
public interface HBaseIndexerOptions extends PipelineOptions {
    ...
    @Description("HBase columns family in which the elements are stored")
    @Default.String("kv")
    String getKVColumnFamily();
    void setKVColumnFamily(String kvColumnFamily);

    @Description("HBase columns family qualifier in which the elements are stored")
    @Default.String("data")
    String getValueColumnQualifier();
    void setValueColumnQualifier(String valueColumnQualifier);
